        ...
        <div class="row gx-1 gx-lg-5" id="imagelist">
            ...
            <div class="col-12 py-1">
                <a onclick="download1()" style="margin-right: auto; margin-left: auto; width: 280px; border: solid 2px; border-left-color: dimgray; border-top-color: dimgray;" class="nav-link bg-light text-center text-black py-2 rounded" id="newTab" href="#">
                    ...
                    <img style="height: 160px;" src="~/Content/Catagories/Gallery/WebArt/Eps/BD-Logo-Master-Black.svg" /> <h6>Download<br />BD-Logo-Master-Black.zip</h6>
                </a>
            </div>
            ...
            <div>
                <a onclick="download2()" style="margin-right: auto; margin-left: auto; width: 280px; border: solid 2px; border-left-color: dimgray; border-top-color: dimgray;" class="nav-link bg-light text-center text-black py-2 rounded" href="#">
                    ...
                    <img style="height: 160px;" src="~/Content/Catagories/Gallery/WebArt/Eps/BD-Logo-Master-White.svg" /> <h6>Download<br />BD-Logo-Master-White.zip</h6>
                </a>
            </div>
...
<script>
    function download1() {
        ...
        if (r == true) {
            window.open("https://illustrate.net/APNazarene/Content/Catagories/Gallery/WebArt/Eps/BD-Logo-Master-Black.zip")
        } else {}
    }
    ...
    function download2() {
        ...
        if (r == true) {
            window.open("https://illustrate.net/APNazarene/Content/Catagories/Gallery/WebArt/Eps/BD-Logo-Master-White.zip")
        } else {}
    }
</script>